 ...
 * \page MIing MIing
 * 
 * MIing calculates the mutual information (or other similarity measure) between pairs of input datasets.
 ...
 * 
 * Note that to use \ref Counter with the output from \c MIing, you should first convert the table of raw
